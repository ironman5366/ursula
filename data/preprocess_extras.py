...
def process_into_csv(in_file_path: Path, out_file_path: Path, process):
...
def process_ratings():
    out_file_path = DATA_OUT_DIR / "ratings.csv"
    process_into_csv(RATINGS_DATA_FILE, out_file_path, process_rating_line)
...
def process_reading_list():
    out_file_path = DATA_OUT_DIR / "reading_list.csv"
    process_into_csv(READING_LOG_DATA_FILE, out_file_path, process_reading_list_line)
