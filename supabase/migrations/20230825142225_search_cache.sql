...
ALTER TABLE "public"."reading_lists" ADD CONSTRAINT "fk_reading_lists_book_id" FOREIGN KEY (
    "book_id"
...
CREATE TABLE "public"."search_cache_books" (
    ...
    CONSTRAINT "fk_cache_id" FOREIGN KEY (
        "cache_id"
    ) REFERENCES "public"."search_cache" ("id"),
    CONSTRAINT "fk_book_id" FOREIGN KEY (
        "book_id"
    ) REFERENCES "public"."books" ("id")
);
