...
ALTER TABLE currently_reading_items DROP CONSTRAINT currently_reading_items_ol_book_id_fkey;
ALTER TABLE currently_reading_items DROP CONSTRAINT fk_currently_reading_items_user_id;
...
ALTER TABLE edition_genres DROP CONSTRAINT edition_genres_genre_id_fkey;
ALTER TABLE edition_genres DROP CONSTRAINT edition_genres_edition_id_fkey;
...
ALTER TABLE ol_ratings DROP CONSTRAINT ol_ratings_book_id_fkey;
ALTER TABLE ol_ratings DROP CONSTRAINT ol_ratings_edition_id_fkey;
...
ALTER TABLE ol_reading_log_items DROP CONSTRAINT ol_reading_log_items_book_id_fkey;
ALTER TABLE ol_reading_log_items DROP CONSTRAINT ol_reading_log_items_edition_id_fkey;
